...
add_action('plugins_loaded', function () {
  ...
  add_filter('plugin_row_meta', function ($plugin_meta, $plugin_file, $_, $__) {
    ...
    $plugin_meta[] = sprintf('<span style="color:red;">%s</span>', __('This plugin requires WP-Stateless plugin version 3.4.0 or greater to be installed and active.', 'slcadivi'));
    return $plugin_meta;
  }, 10, 4);
});
